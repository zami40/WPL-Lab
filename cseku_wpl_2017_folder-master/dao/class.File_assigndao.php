...
Class File_assignDAO{
	...
	public function getAllFile_assigns(){
		...
		$this->_DB->doQuery("SELECT * FROM tbl_file_assign");
	...
	public function createFile_assign($File_assign){
		...
		$SQL = "INSERT INTO tbl_file_assign(ID, FileID, FileComment, IsApproved, IsRejected, PreviousUserID, CurrentUserID, IsPending, HasSeen, CreationDate, ApproveDate, AssignDate) VALUES('$ID','$FileID','$FileComment', '$IsApproved', '$IsRejected', '$PreviousUserID', '$CurrentUserID', '$IsPending', '$HasSeen', '$CreationDate', '$ApproveDate', '$AssignDate')";
	...
	public function readFile_assign($File_assign){
		...
		$SQL = "SELECT * FROM tbl_file_assign WHERE ID='".$File_assign->getID()."'";
	...
	public function searchFile_assign($CurrentUser){
		...
		//echo "SELECT * FROM tbl_file_assign WHERE CurrentUserID = $CurrentUser and IsPending = true";		

		$this->_DB->doQuery("SELECT * FROM tbl_file_assign WHERE CurrentUserID = '".$CurrentUser."'");
		//and IsPending = true");
	...
	public function searchFileID($FileID){
		...
		//echo "SELECT * FROM tbl_file_assign WHERE CurrentUserID = $CurrentUser and IsPending = true";	
		$SQL = "SELECT * FROM tbl_file_assign WHERE FileID = '".$FileID."' ";
		//echo $SQL;
	...
	public function updateFile_assign($File_assign){
		...
		$SQL = "UPDATE tbl_file_assign SET FileID = '".$FileID."', FileComment = '".$FileComment."', IsApproved = '".$IsApproved."', IsRejected = '".$IsRejected."', PreviousUserID = '".$PreviousUserID."', CurrentUserID = '".$CurrentUserID."', IsPending = '".$IsPending."', HasSeen = '".$HasSeen."', CreationDate = '".$CreationDate."', ApproveDate = '".$ApproveDate."', AssignDate = '".$AssignDate."' WHERE ID = '".$ID."'";

		echo $SQL;

		//$SQL = "UPDATE tbl_file_assign SET FileID = $FileID WHERE ID='".$File_assign->getID()."'  ";
///////////next code goes from here....
	...
	public function deleteFile_assign($File_assign){
		...
		$SQL = "DELETE from tbl_file_assign where ID ='".$File_assign->getID()."'";
...
echo '<br> log:: exit the class.File_assigndao.php';
